...
nens=xs.shape[0]
outdir='/home/users/dcw32/figures/thesis/'
outname='power_spectra_'+time.strftime("%Y%m%d")
save=True
format='pdf'
...
ax3.set_ylabel(r'Spectral Power Density / 1000')
qbo_freq=1.0/(f[np.where(Pxx_den==np.max(Pxx_den))[0][0]])
ax3.text(0.9,0.9,"Model",transform=ax3.transAxes\
         ,verticalalignment='center',horizontalalignment='right'\
         ,fontsize='14',color='#D50032')
ax3.text(0.07,0.93,"B",transform=ax3.transAxes\
         ,verticalalignment='center',horizontalalignment='center'\
         ,fontsize='16',color='k')
# DATA
...
ax3.text(0.9,0.83,"Observations",transform=ax3.transAxes\
         ,verticalalignment='center',horizontalalignment='right'\
         ,fontsize='14',color='#E89CAE')
ax3.plot(g,Qxx_den/1000,c='#E89CAE',linewidth=2)
ax3.plot(f, Pxx_den/1000,c='#D50032',linewidth=2)
ax3.yaxis.set_label_position("right")
ax3.yaxis.tick_right()
ax3.yaxis.set_ticks_position('both')
ax4=ax3.twiny()
ax4.set_xlim([0.,1.])
ax4.set_xticks([0.1,0.2,0.5,1.])
ax4.set_xticklabels(['10','5','2','1'])
