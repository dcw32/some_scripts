...
outname='gl_rads_timeseries_ALL'+time.strftime("%Y%m%d")
save=True
format='png'
################################################################
# BEGIN
...
#ax1.legend(fancybox=True,ncol=2,handletextpad=0.1,columnspacing=0.2)
ax1.yaxis.tick_right()
ax1.yaxis.set_ticks_position('both')
ax0.text(0.02,1.02,'C',transform=ax0.transAxes\
...
ax1.text(0.95,0.05,'Surface',transform=ax1.transAxes\
                        ,verticalalignment='bottom',horizontalalignment='right'\
                        ,fontsize='14',color='k')
plt.figtext(0.08,0.5,r"Change to Net Radiative Budget / W m$\mathregular{^{-2}}$"\
