...
var='precip' # Surface Air Temperature
njobs=len(jobids)
#Indices for seasons
nplots=4
ind_1=[6,7,18,24]
...
for i in range(njobs):
	...
	delta=86400*(anomaly_var-baseline_var[base_loc:base_loc+nts,:,:])
...
for i in range(nplots):
	...
	a,b=im0(lonsi,latsi)
	cay=im0.contourf(a,b,store_1,levs,cmap=plt.cm.get_cmap('BrBG'),extend='both')
